...
# Effect Players
# execute as @e[distance=..4] unless entity @s[nbt={Inventory:{Slot:102b,id:"minecraft:netherite_chestplate"}}] unless entity @s[nbt={Inventory:[{Slot:102b, tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] run function thermite:effect
execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:netherite_chestplate"}]}] run function thermite:effect

# working
# execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] run function thermite:effect
# execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:netherite_chestplate"}]}] run function thermite:effect

#execute as @e[distance=..4] unless entity @s[nbt={Inventory:{Slot:102b,id:"minecraft:netherite_chestplate"}}] run function thermite:effect
#execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:leather_chestplate",tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] run function thermite:effect
#execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:iron_chestplate",tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] run function thermite:effect
#execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:gold_chestplate",tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] run function thermite:effect
#execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:chainmail_chestplate",tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] run function thermite:effect
#execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:diamond_chestplate",tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] run function thermite:effect
#execute as @e[distance=..4] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:elytra",tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] run function thermite:effect
